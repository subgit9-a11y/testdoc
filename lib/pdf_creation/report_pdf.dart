...
reportView(ctx, List<Map<String, dynamic>> pdfData, int? id, int? userId,
    String convertMedicine) async {
  ...
  pdf.addPage(MultiPage(
      ...
      header: (Context context) {
        return Container(
            ...
            child: Text(getTranslated(ctx, AppString.report_heading).toString(),
      ...
      footer: (Context context) {
        return Container(
            ...
            child: Text(
                '${getTranslated(ctx, AppString.report_page_heading).toString()} ${context.pageNumber} ${getTranslated(ctx, AppString.page_length).toString()} ${context.pagesCount}',
                style: Theme.of(context)
                    .defaultTextStyle
                    .copyWith(color: PdfColors.grey)));
      },
      build: (Context context) => <Widget>[
            Header(
                ...
                child: Row(
                    ...
                    children: <Widget>[
                      Text(
                          '${getTranslated(ctx, AppString.prescription).toString()}',
                          textScaleFactor: 2),
                      PdfLogo()
                    ])),
