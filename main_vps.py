...
from app.order_management import router as order_router
from app.astra_autopilot.routes import router as autopilot_router
from app.medicine_reminders.supabase_routes import router as supabase_reminder_router
from app.admin_routes import router as superadmin_router
...
v1_router.include_router(supabase_reminder_router)  # /api/v1/api/reminders
v1_router.include_router(autopilot_router)    # /api/v1/autopilot
v1_router.include_router(superadmin_router)   # /api/v1/admin
...
v1_router.include_router(order_router)        # /api/v1/orders
v1_router.include_router(autopilot_router)    # /api/v1/autopilot
v1_router.include_router(agora_router)        # /api/v1/video

# 9. Main Application Assembly has /brain or its own versioning
