...
def run_full_flow():
    ...
    fill_data = {
        "text": "I have been suffering from severe migraine attacks for the past few weeks. The pain is throbbing and usually on one side of my head, accompanied by nausea and sensitivity to light. It triggers when I am stressed or exposed to bright sunlight. I tried taking painkillers but they are not very effective anymore. My email is d.subash2710@gmail.com and phone is 6380176373.",
        "user_id": patient_id
    }
    ...
    case_data = {
        ...
        "user_id": patient_id,
        "doctor_id": doctor_id,
        "diagnosis": "Vata-Pitta imbalance causing Migraine (Ardhavabhedaka)",
    ...
    prescription_data = {
        ...
        "diagnosis": "Vata-Pitta imbalance causing Migraine (Ardhavabhedaka)",
        "notes": "Patient to follow strict Ayurvedic diet plan. Avoid bright lights and stress. Stay hydrated.",
        "medicines": [
            {
    ...
    pdf_data = {
        ...
        "diagnosis": "Migraine (Ardhavabhedaka)",
        "doctor_notes": "Follow Ayurvedic diet plan strictly. Avoid stress and bright sunlight."
    }
